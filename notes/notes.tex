...
\begin{experiment}
  ...
  \begin{figure}[H]
    \begin{subfigure}{0.65\textwidth}
      \includegraphics[width=\linewidth]{images/experiments/forwardback4/firefox/2.png}
    \end{subfigure}
    \begin{subfigure}{0.25\textwidth}
      \resizebox{\linewidth}{!}{
        \begin{tikzpicture}
  ...
  \begin{figure}[H]
    \begin{subfigure}{0.65\textwidth}
      \includegraphics[width=\linewidth]{images/experiments/forwardback4/firefox/3.png}
    \end{subfigure}
    \begin{subfigure}{0.25\textwidth}
      \resizebox{\linewidth}{!}{
        \begin{tikzpicture}
  ...
  \begin{figure}[H]
    \begin{subfigure}{0.65\textwidth}
      \includegraphics[width=\linewidth]{images/experiments/forwardback4/firefox/4.png}
    \end{subfigure}
    \begin{subfigure}{0.25\textwidth}
      \resizebox{\linewidth}{!}{
        \begin{tikzpicture}
