...
\tikzstyle{active} = [draw=black, color=white, fill=blue!50!black, circle]
...
\begin{counterexample}
  Let $H$ be:
  \[\begin{tikzpicture}
    \node[doc,active](0) at (0,0){0};
    \node[doc,active](1) at (1,-1){1};
    \node[doc](2) at (2,-1){2};
